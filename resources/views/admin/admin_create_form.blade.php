...
<div class="form-group">
	...
	<input type="text" name="job_title" id="job_title" class="form-control" value="{{ old('job_title') }}" maxlength="60" required>
</div>
...
<hr>
<div class="form-group">
	<button type="submit" class="btn btn-primary btn-lg btn-block btn-ww-lg" id="submitBtn" onclick="restrict()">Next <span class="btn-arrow">&#8594;</span></button>
