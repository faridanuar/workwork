...
return [
    'welcome' => '<h3>Welcome</h3>
        <p>Have a few extra hours per day or week and looking to make some extra money? </p>
        <p>Find a part-time job that is interesting, nearby and pays decently (average hourly wage starts at RM5)</p>',
