...
<div class="form-group">
	...
	<input type="text" name="advert_from" id="advert_from" class="form-control" value="{{ $advert->advert_from }}" maxlength="60" required>
</div>
...
<div class="form-group">
	...
	<a href="/a/dashboard" class="btn btn-link">Cancel</a>
</div>