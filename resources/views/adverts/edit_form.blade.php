...
<div class="form-group">
	...
	<textarea type="text" name="description" id="description" class="form-control" rows="10" required>{{ $job->description }}</textarea>
</div>
...
<div class="form-group">
	...
	<input type="text" name="business_name" id="business_name" class="form-control" value="{{ $job->business_name }}" required>
</div>

<div class="form-group">
	<label for="business_logo">Business logo: (optional)</label>
	<input type="file" name="business_logo" id="business_logo" class="form-control" value="{{ $job->business_logo }}">
</div> 	

<div class="form-group">
	<label for="street">Street:</label>
	<input type="text" name="street" id="street" class="form-control" value="{{ $job->street }}" required>
</div> 
...
<div class="form-group">
	...
	<input type="text" name="zip" id="zip" class="form-control" value="{{ $job->zip }}" required>
</div> 

<div class="form-group">
	<label for="state">State:</label>
	<input type="text" name="state" id="state" class="form-control" value="{{ $job->state }}" required>
</div>	
